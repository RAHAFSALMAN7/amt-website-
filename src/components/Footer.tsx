...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-[#851A18] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24 text-left">

        {/* Logo + ISO Certificates */}
        <div className="flex flex-col items-start gap-6">
          <img src={Logo} alt="AMT Logo" className="w-56 h-auto object-contain" />

          <div className="flex gap-8 mt-2 flex-wrap">
            {/* ISO 9001 */}
            <div className="flex flex-col items-start text-sm md:text-base">
              <img src="/images/Logo_of_the_ISO.png" alt="ISO 9001 Logo" className="w-28 h-auto object-contain" />
              <a
                href="/pdf/AMT_iso.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline mt-1 text-[#292929]"
              >
                ISO 9001:2015
              </a>
            ...
            {/* ISO 45001 */}
            <div className="flex flex-col items-start text-sm md:text-base">
              <img src="/images/Logo_of_the_ISO.png" alt="ISO 45001 Logo" className="w-28 h-auto object-contain" />
              <a
        ...
        <div className="flex flex-col items-start text-left">
          <span className="font-semibold text-lg mb-3">{t.contactUsTitle}</span>
          <div className="space-y-3 text-sm md:text-base text-[#292929]">
            <div>Tel.: +966 13 810 05 47</div>
            <div>Email: info@amt-arabia.com</div>
          </div>

          <div className="mt-8">
            <span className="font-semibold text-lg mb-3 block">{t.officeHoursTitle}</span>
            <div className="space-y-2 text-sm md:text-base text-[#292929]">
      ...
      <div className="mt-12 border-t border-gray-300 pt-6 flex flex-col lg:flex-row justify-between text-left text-sm text-[#292929]">
        ...
        <div className="flex space-x-6 mt-3 lg:mt-0">
          {t.bottom.map((link, i) => (
